    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Edit Fiverr Profile</h4>
                <h6><a href="{{ route('fiverr-profiles.index') }}">All Profiles /</a> Edit Profile</h6>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <form action="{{ route('fiverr-profiles.update', $fiverrProfile->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="{{ $field }}" class="form-control" value="{{ old($field, optional($fiverrProfile)->$field ?? '') }}" placeholder="Enter {{ ucwords(str_replace('_', ' ', $field)) }}">
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="col-lg-12">
                            <button type="submit" class="btn btn-primary">Update Fiverr Profile</button>
                        </div>
                    </div>
                </form>
            </div>
